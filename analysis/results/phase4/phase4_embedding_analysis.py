...
class EmbeddingPerturbationAnalyzer:
    ...
    def load_model(self):
        ...
        try:
            ...
            print(f"[MODEL] Loaded Geneformer V1-10M ({bert_config.hidden_size}D embeddings)")
    ...
    def analyze_cells(self):
        ...
        print(f"[GENES] Processing {len(self.config['target_genes'])} target genes")
        ...
        for batch_idx in range(n_batches):
            ...
            if batch_results:
                ...
                print(f"[SAVE] Saved batch {batch_idx + 1} results: {len(batch_results)} perturbations")
...
def main():
    ...
    try:
        ...
        print("\n[SUCCESS] Phase 4 analysis completed successfully!")
